    ...
    <main id="content" className="relative w-full min-h-screen">
      ...
      <div className="container mx-auto flex min-h-[calc(100vh-8rem)] max-w-4xl flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <div className="mb-8 space-y-4">
          <h2 className="text-3xl font-bold text-gray-800 md:text-4xl">Página No Encontrada</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            Lo sentimos, la página que buscas no existe o ha sido movida. Verifica la URL o regresa al inicio para
        ...
        <div className="mt-16 w-full">
          <h3 className="mb-6 text-xl font-semibold text-gray-800">Enlaces Útiles</h3>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Link
              href="/nosotros"
              className="rounded-lg border border-gray-200 p-4 transition-all hover:border-brand-700 hover:shadow-md"
            >
              <i className="fas fa-users text-brand-700 mb-2 text-2xl"></i>
              <h4 className="text-base font-semibold text-gray-800">Nosotros</h4>
              <p className="mt-1 text-sm text-gray-600">Conoce más sobre Cefortte</p>
            </Link>
            ...
            >
              ...
              <h4 className="text-base font-semibold text-gray-800">Soluciones</h4>
              <p className="mt-1 text-sm text-gray-600">Para empresas</p>
            </Link>
            ...
            >
              ...
              <h4 className="text-base font-semibold text-gray-800">Blog</h4>
              <p className="mt-1 text-sm text-gray-600">Artículos y noticias</p>
            </Link>
            ...
            >
              ...
              <h4 className="text-base font-semibold text-gray-800">Cotización</h4>
              <p className="mt-1 text-sm text-gray-600">Solicita presupuesto</p>
            </Link>
          </div>
        </div>
        ...
        <div className="mt-12 w-full">
          <h3 className="mb-6 text-xl font-semibold text-gray-800">Categorías de Cursos Populares</h3>
          <div className="flex flex-wrap justify-center gap-3">
            <Link
              href="/cursos/seguridad-operativa"
              className="rounded-full border border-gray-300 px-4 py-2 text-sm transition-colors hover:border-brand-700 hover:bg-brand-700 hover:text-white"
            >
              Seguridad Operativa
            </Link>
            <Link
        ...
        <div className="bg-brand-50 mt-12 w-full rounded-lg p-6">
          <h3 className="mb-3 text-lg font-semibold text-gray-800">¿Necesitas Ayuda?</h3>
          ...
          <div className="flex flex-col gap-2 text-sm text-gray-700 sm:flex-row sm:justify-center sm:gap-6">
            ...
            <a href="mailto:contacto@cefforte.com.mx" className="hover:text-brand-700 transition-colors">
              <i className="fas fa-envelope mr-2"></i>
