        ...
        <div className="contenido">
          ...
          <ul className="encabezado border-b border-white/10">
            <li className="elemento brand relative">
              <a className="enlace enlace-brand" aria-label="Tile menu" href="#">
                <span className="enlace-text">Title menu</span>
              </a>
            </li>
                ...
                <div className="flex h-full items-center justify-end pr-6">
                  <ul className="flex h-16 items-center md:space-x-3 lg:space-x-4 xl:space-x-6">
                    <li className="flex h-full items-center">
                      <a href="#" className="group relative flex h-full items-center px-2 text-xs font-normal text-stone-600 transition-colors hover:text-stone-800 active:text-stone-950">
                    ...
                    <li className="flex h-full items-center">
                      <a href="#" className="bg-brand-700 hover:bg-brand-600 active:bg-brand-700 rounded-xs inline-block inline-flex w-max items-center justify-center px-4 py-2.5 text-sm font-bold tracking-wide text-stone-50 transition-colors">
                  ...
                  <div className="grid grid-cols-1 justify-between md:grid-cols-2 md:grid-cols-[auto_1fr]">
                    ...
                    <div className="grid-cols-1">
                      <nav>
                        <ul className="space-y-4">
                          <li>
                            <a href="#">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Inicio</h4>
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Nosotros</h4>
                            </a>
                          </li>
                          <li>
                            <a href="#" className="sm:hidden">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Cursos</h4>
                            </a>
                          </li>
                          <li>
                            <a href="#">
                          ...
                          <li>
                            <a href="#">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Testimonios</h4>
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Blog</h4>
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <h4 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">Contáctanos</h4>
                            </a>
                          </li>
                          <li className="mt-6">
                            <a href="#">
                              <h5 className="text-brand-700 rounded-xs inline-block inline-block w-max bg-stone-100 px-3 py-3 transition-colors transition-transform hover:translate-x-1 hover:bg-stone-50 active:bg-white">Cotizar ahora</h5>
                            </a>
                          </li>
                        </ul>
                      </nav>
                      ...
                      <li className="mt-12 flex gap-6">
                        <a href="#" className="text-stone-100 transition-all duration-150 hover:-translate-y-0.5 hover:text-white active:text-white" aria-label="Facebook">
                          <i className="fab fa-facebook-f text-3xl"></i>
                        </a>
                        <a href="#" className="text-stone-100 transition-all duration-150 hover:-translate-y-0.5 hover:text-white active:text-white" aria-label="YouTube">
                          <i className="fab fa-youtube text-3xl"></i>
                        </a>
                        <a href="#" className="text-stone-100 transition-all duration-150 hover:-translate-y-0.5 hover:text-white active:text-white" aria-label="Instagram">
                          <i className="fab fa-instagram text-3xl"></i>
                        </a>
                        <a href="#" className="text-stone-100 transition-all duration-150 hover:-translate-y-0.5 hover:text-white active:text-white" aria-label="LinkedIn">
                    ...
                    <div className="hidden grid-cols-2 md:mx-auto md:block">
                      ...
                      <ul className="space-y-3">
                        <li>
                          <a href="#" className="inline-block text-base font-medium text-stone-100 transition-transform hover:translate-x-1 hover:text-white active:text-white">
                            Seguridad Operativa
                          </a>
                        </li>
                        <li>
                    ...
                    <div className="justify-between:justify-self-start items-center">
                      <form className="space-y-3">
                        <div className="flex flex-col gap-2 sm:flex-row">
                          ...
                          <input id="email-newsletter" type="email" name="email" required placeholder="tu@correo.com" autoComplete="email" className="flex-1 border border-white/20 bg-white/5 px-3 py-2 text-sm text-white transition-all duration-200 placeholder:text-white/50 focus:border-white/40 focus:bg-white/10 focus:outline-none focus:outline-none focus:ring-0" />
                          <button type="submit" className="rounded-xs text-brand-700 cursor-pointer whitespace-nowrap bg-stone-100 px-6 py-2 text-sm font-semibold transition-colors transition-transform hover:translate-x-1 hover:bg-stone-50 active:bg-white">
                            Suscribirse
                          </button>
                        </div>
                      </form>
                      <small className="text-stone-200">
                        ...
                        <span className="inline">
                          <a href="#" className="text-xs text-stone-100 hover:text-white">
                            aviso de privacidad.
                          </a>
                        </span>
                      </small>
