          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              <ul className="space-y-3">
                <li>
                  <Link href="/">
                    <h5 className="inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">
                      Inicio
                    </h5>
                  </Link>
                </li>
            ...
            <div>
              <Link href="/cursos">
                <h5 className="mb-6 inline-block text-stone-100 transition-transform hover:translate-x-1 hover:text-stone-50 active:text-white">
            ...
            <div className="md:col-span-2 lg:col-span-1">
              <div className="rounded-xs flex h-full flex-col justify-center border border-white/20 p-8 transition-all duration-300 hover:border-white/40 hover:bg-white/5">
                <h6 className="mb-6 inline-block text-stone-100 hover:text-stone-50 active:text-white">
                  ¿Necesitas una Cotización?
                </h6>
                <p className="mb-6 text-base leading-relaxed text-stone-100">
                  Obtén una cotización personalizada para las necesidades específicas de tu empresa
                  en minutos.
                </p>
                <Link
                  href="/cotizacion"
            ...
            <ul className="flex flex-col items-center gap-2 sm:flex-row sm:gap-6">
              <li>
                <Link
                  ...
                  className="inline-block text-sm text-stone-100 transition-all duration-150 hover:translate-x-1 hover:text-stone-50 active:text-white"
                >
                  Términos y Condiciones
                </Link>
              </li>
              <li className="text-brand-200 hidden text-sm sm:block" aria-hidden="true">
                |
              </li>
              <li>
                <Link
          ...
          <div className="order-1 lg:order-3 lg:justify-self-end">
            <ul className="flex items-center justify-center gap-6" aria-label="Redes sociales">
              <li>
                <a
                  href="#"
                  className="inline-block text-stone-100 transition-all duration-150 hover:-translate-y-0.5 hover:text-white active:text-white"
                  aria-label="Facebook"
                >
